...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        bluedrop:
          "radial-gradient(49% 81% at 10% 100%, #e0eff4 0%, #073AFF00 100%),radial-gradient(113% 91% at 10% 0%, #c1dee4 1%, #CBE4E8 99%),radial-gradient(142% 91% at 83% 7%, #CBE4E8 1%, #FF000000 99%);",
      },
      colors: {
