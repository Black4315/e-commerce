...
const CampaignOffer = () => {
    ...
    return (
        <CampaignOfferContext.Provider value={{ data, isLoading, isError }}>
            ...
            <div className="bg-black flex w-full h-fit md:h-[500px] max-md:rounded-lg relative my-10 md:my-18 md:py-15 lg:py-17 p-6 md:px-12 lg:px-14 justify-between md:items-center max-md:flex-col">
