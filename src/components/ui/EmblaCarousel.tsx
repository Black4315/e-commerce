    ...
    ({ slides, options, children, className, btnClassName }, ref) => {
        ...
        return (
            <div className='relative'>
                <div className={cn("md:ms-auto flex gap-2 max-md:self-center absolute -top-19.5 md:-top-[107px] md:end-0 end-1/2 max-md:translate-x-1/2 !z-10 bg-white",btnClassName)}>
