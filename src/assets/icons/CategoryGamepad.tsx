...
const CategoryGamepadIcon = (props: Props) => (
  <svg {...props} width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_138_1677)">
      ...
      <path d="M14 28H23.3333M18.6667 23.3333V32.6667" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M35 25.6667V25.6908" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
...
export default CategoryGamepadIcon;
